...
contract Hub {
    ...
    mapping(address => bool) public freeDeployUsed;
    ...
    function deployToken(
        ...
        bool isFree = !freeDeployUsed[msg.sender];
        uint256 pointsEarned;

        if (isFree) {
            if (msg.value != 0) revert UnexpectedPayment();
            freeDeployUsed[msg.sender] = true;
